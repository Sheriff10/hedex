        ...
        <div className="wrap bg-sec text-gray-300 py-32" id='premium'>
            <Container>
                <div className="heading text-center mb-5">
                    ...
                    <span className=' font-extrabold text-3xl lg:text-5xl text-white'><span className='text-grad'> Premium</span>  Bot <span className='text-grad'> And Prices</span> </span>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-10 py-5 ">
                    <div className="card i-bg-con2 rounded-3xl overflow-hidden shadow-2xl scale-90">
                    ...
                    <div className="card i-bg-con2 rounded-3xl overflow-hidden shadow-2xl">
                        <div className="bg-con bg-white bg-opacity-10 backdrop-blur-3xl rounded-t-3xl p-5">
                            <div className="img-wrap bg-neutral-900 py-3 bg-opacity-70 backdrop-blur-3xl rounded-t-3xl">
